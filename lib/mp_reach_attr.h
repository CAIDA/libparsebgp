 ...
 * Encoding).
 *
 * \param [in]   isIPv4                     True false to indicate if IPv4 or
 * IPv6 \param [in]   data                       Pointer to the start of the
 * prefixes to be parsed \param [in]   len                        Length of the
 * data in bytes to be read \param [in]   peer_info                  Persistent
 * Peer info pointer \param [out]  prefixes                   Reference to a
