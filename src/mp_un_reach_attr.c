...
static void libparsebgp_mp_un_reach_attr_parse_afi_ipv4_ipv6(bool is_ipv4, mp_unreach_nlri *nlri, u_char **data, int len) {
    ...
    switch (nlri->safi) {
        case BGP_SAFI_UNICAST: // Unicast IP address prefix
            libparsebgp_mp_reach_attr_parse_nlri_data_ipv4_ipv6(is_ipv4, data, len, nlri->withdrawn_routes_nlri.wdrawn_routes, &nlri->count_wdrawn_routes);
            break;

        case BGP_SAFI_NLRI_LABEL: // Labeled unicast
            libparsebgp_mp_reach_attr_parse_nlri_data_label_ipv4_ipv6(is_ipv4, data, len, nlri->withdrawn_routes_nlri.wdrawn_routes_label, &nlri->count_wdrawn_routes_label);
            break;
