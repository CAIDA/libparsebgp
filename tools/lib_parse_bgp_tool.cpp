                ...
                case TABLE_DUMP_V2: {
                    ...
                    switch (parse_msg->parsed_mrt_msg.c_hdr.sub_type) {
                        ...
                        case RIB_IPV6_UNICAST: {
                            out << parse_msg->parsed_mrt_msg.c_hdr.time_stamp << "|||||" << parse_msg->parsed_mrt_msg.parsed_data.table_dump_v2.rib_entry_hdr.prefix;
                            break;
                        }
                        case RIB_GENERIC: {
                ...
                case BGP4MP_ET: {
                    ...
                    switch (parse_msg->parsed_mrt_msg.c_hdr.sub_type) {
                        ...
                        case BGP4MP_STATE_CHANGE_AS4: {
                            out << "S|" << parse_msg->parsed_mrt_msg.c_hdr.time_stamp << "|||" << parse_msg->parsed_mrt_msg.parsed_data.bgp4mp.bgp4mp_state_change_msg.peer_asn
